        ...
        let DEFAULT_BPP = 32;
        let DEFAULT_ROOT_ZIP_FILE = "Debian10-Wine-5.0.zip";//"boxedwine_with_dll.zip";//"boxedwine.zip";
        //params
        let Config = {};
        Config.urlParams = "";
    ...
    var flag_r = { isReadable: function() { return true; },
        ...
        function setConfiguration() {
            ...
            Config.appZipFile = "bwa.zip";//getAppZipFile("app"); //MANUAL:"chomp.zip";
            Config.rootZipFile = DEFAULT_ROOT_ZIP_FILE;//getRootZipFile("root"); //MANUAL:"base.zip";
            Config.Program = "bwa_launcher.exe";//getExecutable(); //MANUAL:"CHOMP.EXE";
